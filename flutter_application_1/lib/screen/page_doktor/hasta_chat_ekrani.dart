...
class HastaChatEkrani extends StatefulWidget {
  HastaChatEkrani(
  ...
  @override
  State<HastaChatEkrani> createState() => _HastaChatEkraniState();
}

class _HastaChatEkraniState extends State<HastaChatEkrani> {
  List<Mesaj> mesajlar = [];
